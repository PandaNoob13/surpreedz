                ...
                <div className="collapse navbar-collapse px-3" id="navbarSupportedContent">
                    ...
                    { token ?
                        <ul className="navbar-nav mb-2 mb-lg-0" >
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="" aria-expanded="false">
                                    Buyer
                                </a>
                                <ul className="dropdown-menu dropdown-menu-end animate slideIn" aria-labelledby="navbarDropdown">
                            ...
                            <li className="nav-item dropdown">
                                <div className="nav-link dropdown-toggle me-2 pt-1 pb-2 dropdown-profile"  id="navbarDropdown" role="button" data-bs-toggle="" aria-expanded="false">
                                    <img className="rounded-circle" style={{width:'1.5rem',height:'1.5rem', marginTop:'0.1rem', objectFit: "cover"}} src={`data:image/jpg;base64,${photo_profile}`} alt="" />
                                </div>
                                <ul className="dropdown-menu dropdown-menu-end animate slideIn" aria-labelledby="navbarDropdown">
