...
const ServiceCard = () => {
    const {name, category, currency, price, rating} = serviceCardData;

    return (
        <div className="card" style={{width: '10rem', height: "300px", borderRadius: "12px", backgroundColor:"#373535"}}>
            <img src="https://jabarekspres.com/wp-content/uploads/2020/11/Gisel-.jpg" className="card-img-top" style={{width: '100%', padding: "4px", height: '200px', objectFit: "cover", borderRadius: "12px"}} alt="artist"/>
            <div className="card-body text-white" style={{padding: "8px"}}>
                ...
                <div className='d-flex flex-row justify-content-between'>
                    <p className="card-te
    console.log(name);xt" style={{fontSize: "0.9rem", marginBottom: "0px"}}>{currency} {price}</p>
